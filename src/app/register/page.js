        ...
        return (
            <div>
                ...
                <div className='min-h-screen flex flex-col justify-center items-center bg-gray-100'>
                    <div className='w-[500px] md:w-[500px] lg:w-[500px] h-[450px] bg-gray-200 shadow-lg rounded-3xl p-4 mx-auto my-auto'>
                        <div className={'w-full flex flex-col justify-center'}>
                            ...
                            <form action="" className='flex flex-col justify-center p-3 gap-5 mt-3 items-center'>
                                <div className='flex flex-col justify-center gap-5 w-full'>
                                    <input className='p-2 focus:outline-none shadow-lg rounded' type="text" name='Name' placeholder='User Name' onChange={e => this.setState({ name: e.target.value })} />
